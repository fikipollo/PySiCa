...
cache.add("3", {"name": "a more complex example", "beers" : 250, "the_list": [1, 2, 3, "asd"], "a_dict": {"a": 1, "b": "test", "c": [3, 2, 1]}}, data_type="superobjects")
cache.add("4", {"name": "extra elem", "coffees" : 30}, data_type="superobjects")
...
i+=1
result = cache.remove("2", user_id="1")
